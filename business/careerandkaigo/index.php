...
<link rel="stylesheet" href="https://use.typekit.net/jsg6vlq.css">
...
<?php require_once($_SERVER['DOCUMENT_ROOT'].'/assets/include/header_lp.php'); ?>
<!-- ===== lpコンテンツ部分ヘッダーナビ/ ===== -->
<div class="armg_lpheader" >
	<div class="inner">
        ...
        <div class="armg_lpheader_logo"> <span class="armg_lpheader_logo_detail"> 
			...
			<div class="armg_ui_spnav">
				<label type="button" class="btn_spnavbtn" data-navclass="armg_lpheader_nav">
					<span>MENU</span>
				</label>
			</div>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'].'/assets/include/footer.php'); ?>
<?php require_once($_SERVER['DOCUMENT_ROOT'].'/assets/include/footer_link.php'); ?>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'].'/assets/include/footer_tag.php'); ?>
</body>
</html>